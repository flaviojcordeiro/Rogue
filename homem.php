...
<body bgcolor="FFFEF8">
    ...
    <div class="card-container">
        ...
        <div class="btns">
            <button onclick="toggleFavorite('btn-fav1', 'mascroupa1')" id="btn-fav1" class="favorite-btn"><i class="fa-regular fa-heart"></i></button>
        </div>
        <p>R$ 149,99</p>
        ...
        <div class="btns">
            <button onclick="toggleFavorite('btn-fav2', 'mascroupa2')" id="btn-fav2" class="favorite-btn"><i class="fa-regular fa-heart"></i></button>
        </div>
        <p>R$ 249,99</p>
        <div class="add-carrinho">Adicionar ao carrinho</div>
        </div>
        ...
        <h3>Polo Branca</h3>
        <div class="btns">
            <button onclick="toggleFavorite('btn-fav3', 'mascroupa3')" id="btn-fav3" class="favorite-btn"><i class="fa-regular fa-heart"></i></button>
        </div>
        <p>R$ 99,99</p>
        <div class="add-carrinho">Adicionar ao carrinho</div>
        </div>
